...
public class MappingProfiles : Profile
{
    public MappingProfiles()
    {
        ...
        //.ForMember(dest => dest.CatalogManagements, opt => opt.MapFrom(src =>
        //{
        //    var list = new List<GetListCatalogManagementListItemDto>();

        //    // Kitaplarý ekleme
        //    if (src.CatalogManagements != null)
        //    {
        //        list.AddRange(src.CatalogManagements
        //            .Where(cm => cm.Book != null)
        //            .Select(cm => new GetListCatalogManagementListItemDto
        //            {
        //                Id = cm.Id,
        //                CatalogId = cm.CatalogId,
        //                CatalogName = cm.Catalog.Name,
        //                BookId = cm.BookId,
        //                BookBookTitle = cm.Book.BookTitle
        //            }));
        //    }
        ...
        //                CatalogId = cm.CatalogId,
        //                CatalogName = cm.Catalog.Name,
        //                MagazineId = cm.MagazineId,
        //                MagazineMagazineTitle = cm.Magazine.MagazineTitle
        //            }));
        //    }
        ...
        //    return list; // Son listeyi döndür
        //}))
