...
public class BookConfiguration : IEntityTypeConfiguration<Book>
{
    public void Configure(EntityTypeBuilder<Book> builder)
    {
        ...
        builder.HasData(
            ...
            new Book() { Id = Guid.Parse("cbcaea85-df78-4fb5-9219-13bcc50dc1fa"), ISBNCode = "9473284657234", BookTitle = "Metal Fýrtýna", BookEdition = 14, ReleaseDate = 2004, Status = Domain.Enums.BookStatus.Available, PublisherId = Guid.Parse("9acb5f4c-966e-44a4-8ddb-9fe31fa0090e"), CategoryId = 3, LocationId = Guid.Parse("57cac248-2a17-43bf-a584-9d2e7e966457"), CreatedDate = DateTime.UtcNow }
            );
