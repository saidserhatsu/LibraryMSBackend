...
public class BookConfiguration : IEntityTypeConfiguration<Book>
{
    public void Configure(EntityTypeBuilder<Book> builder)
    {
        ...
        builder.HasData(
            ...
            new Book() { Id = Guid.Parse("a6e2a4ba-ab5f-473d-a47e-b6634c241389"), ISBNCode = "9786050954201", BookTitle = "Beyaz Zambaklar Ülkesinde", BookEdition = 1, ReleaseDate = 1928, PageCount = 216, Status = BookStatus.Available, PublisherId = Guid.Parse("96946aaa-597d-4b96-a270-02a46204ebf6"), CategoryId = 3, LocationId = Guid.Parse("57cac248-2a17-43bf-a584-9d2e7e966457"), CreatedDate = DateTime.UtcNow ,ImageUrl= "https://res.cloudinary.com/dafqsbtn7/image/upload/v1714568273/ekcesgl02ump0lq0mcoj.png"}
            );
